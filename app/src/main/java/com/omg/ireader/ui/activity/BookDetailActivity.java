...
public class BookDetailActivity extends BaseMVPActivity<BookDetailContract.Presenter>
    ...
    public static void startActivity(Context context,String bookId){
        ...
        if (bookId.contains("storage")){
            ToastUtils.show("本地文件暂无简介");
        }else {
